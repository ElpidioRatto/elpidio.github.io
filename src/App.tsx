...
const whyNMPoints = [
  {
    ...
    description: "Permette di creare un’attività indipendente senza investimenti iniziale.",
    icon: (
...
const trainingPoints = [
    { text: "Formazione pratica su strategie e relazioni con persone." },
  ...
  <Section id="perche-oggi" className="bg-primary-600 text-white">
      <div className="text-center">
          ...
          <p className="text-lg md:text-xl text-primary-100 max-w-3xl mx-auto">
             Iniziare nel Network Marketing oggi significa anticipare il futuro del lavoro: più persone cercano fonti di reddito flessibili e possibilità di crescita personale. Con Amway puoi costruire un reddito extra, sviluppare una rete di persone e crescere continuamente, con il sostegno di una comunità e di strumenti concreti.
          </p>
      </div>
  </Section>
);
...
const Training = () => (
  <Section id="formazione" className="bg-white">
    <SectionTitle>Formazione: Cumlaude21 — un unico percorso integrato</SectionTitle>
    <div className="max-w-3xl mx-auto text-center">
      <p className="text-lg text-slate-600 leading-relaxed mb-12">
        La formazione è la base di ogni successo. Per questo il percorso formativo di Cumlaude21 va a pari passo con la crescita della tua attività. Senza dedicare ulteriore tempo, o dividere le cose, puoi migliorare come persona e professionalmente nello stesso tempo.
      </p>
    </div>
